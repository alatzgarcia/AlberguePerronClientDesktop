    ...
    public void start(Stage primaryStage) throws Exception {
        try{
           //Get the logic manager object for the initial stage
            IRegister loginManager = IRegisterFactory.getRegisterManager();
            
            //Load the fxml file
            FXMLLoader loader = new FXMLLoader(getClass()
                    .getResource("/albergueperronclient/ui/fxml/UIRegister.fxml"));
            ...
            */
            loginController.setRegisterManager(loginManager);
